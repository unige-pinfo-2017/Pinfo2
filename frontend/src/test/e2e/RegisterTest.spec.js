describe("Login Tests",function(){
	...
	it("it should confirm if Register word exists", function(){
	...
	it("it should confirm if Cancel button exists", function(){
		var countButtonRegister=element.all(by.buttonText("Cancel")).count();
		expect(countButtonRegister,1);
	});
