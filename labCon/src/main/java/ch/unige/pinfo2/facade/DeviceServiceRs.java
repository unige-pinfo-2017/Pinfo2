...
public class DeviceServiceRs {
	...
	public JsonObject getIds() {
		...
		JsonObject jsonDeviceIds = factory.createObjectBuilder()
				.add("deviceIds",
						factory.createObjectBuilder().add("lightIds", jsonLightIdsContentBuilder.build())
	...
	public JsonObject getWorkstation(@QueryParam("deviceId") String deviceId) {
		...
		JsonObject jsonWorkstation = factory.createObjectBuilder().add("workstation", deviceWorkstation).build();
	...
	public JsonObject getHubSocketIds(@QueryParam("workstation") String workstation) {
		...
		JsonObject jsonSocketIds = factory.createObjectBuilder().add("socketIds", jsonSocketIdsContentBuilder.build())
				.build();
